...
*The methodology behind an HBR-published Amazon framework — taught as a hands-on course built on production infrastructure.*

---

In 2025, Harvard Business Review published a case on the causal measurement framework behind Amazon Catalog AI — a system that measures the impact of product data improvements, scores the reliability of each estimate, and allocates resources based on what the evidence actually supports. This course teaches the methodology behind that system, built on the same design principles, using open-source tools you can run yourself.
