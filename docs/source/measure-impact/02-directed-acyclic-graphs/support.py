...
def create_quality_score(metrics_df, seed=42):
    ...
    revenue_normalized = (product_revenue["baseline_revenue"] - product_revenue["baseline_revenue"].min()) / (
        product_revenue["baseline_revenue"].max() - product_revenue["baseline_revenue"].min() + 1e-6
    )
