...
- [ ] Integrate `recurring-loop.svg` into the Measure Impact introduction as a visual summary of the application lecture workflow. Labels align with course sections: Measure = Measure Impact, Evaluate = Evaluate Evidence. File stored in `docs/source/_static/`
